  ...
  return (
    <div className="flex flex-col gap-4 pb-6" role="status" aria-label="Loading transactions">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <div className="flex flex-col gap-4 lg:col-span-2"><div className="rounded-2xl border border-border/60 bg-card p-4"><div className="flex gap-2"><Skeleton className="h-8 flex-1 rounded-lg" /><Skeleton className="h-8 w-24 rounded-lg" /><Skeleton className="h-8 w-24 rounded-lg" /></div></div><div className="overflow-hidden rounded-2xl border border-border/60 bg-card"><div className="flex items-center gap-3 border-b border-border/50 px-5 py-5"><Skeleton className="size-9 rounded-xl" /><div className="space-y-2"><Skeleton className="h-4 w-32" /><Skeleton className="h-2.5 w-44" /></div></div><div className="overflow-x-auto px-5">{[0, 1, 2, 3, 4].map((item) => <div key={item} className="flex min-w-[700px] items-center gap-6 border-b border-border/30 py-4 last:border-0"><div className="w-32 space-y-2"><Skeleton className="h-3 w-24" /><Skeleton className="h-2.5 w-16" /></div><div className="w-24 space-y-2"><Skeleton className="h-3 w-20" /><Skeleton className="h-2.5 w-14" /></div><Skeleton className="h-3 w-28" /><Skeleton className="h-5 w-14 rounded-md" /><Skeleton className="ml-auto h-4 w-24" /><Skeleton className="size-7 rounded-md" /></div>)}</div></div></div>
