    ...
    <div className="mx-auto flex w-full max-w-[1600px] flex-col gap-4 px-4 pb-6 md:px-8" role="status" aria-label="Loading payments">
      ...
      <section className="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]" aria-label="Loading payment analytics">
        <CardShell className="min-h-[360px]">
          <div className="flex items-center justify-between gap-3 px-4 pt-3 sm:px-6 sm:pt-4"><Skeleton className="h-4 w-32" /><Skeleton className="h-8 w-20 rounded-lg" /></div>
      ...
      <CardShell>
        <div className="flex items-center justify-between border-b border-border/25 px-4 py-3 sm:px-6 sm:py-4"><Skeleton className="h-4 w-32" /><Skeleton className="h-8 w-20 rounded-lg" /></div>
