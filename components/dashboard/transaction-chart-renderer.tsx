...
export function TransactionChartRenderer() {
  return (
    <Card className="card-base card-elevated h-full min-w-0 py-0 gap-0">
      <CardHeader className="flex flex-row items-center justify-between border-b border-transparent px-5 pb-3 pt-3">
